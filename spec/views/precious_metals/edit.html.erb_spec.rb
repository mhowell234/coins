...
describe "precious_metals/edit" do
  before(:each) do
  ...
  it "renders the edit precious_metal form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => precious_metals_path(@precious_metal), :method => "post" do
