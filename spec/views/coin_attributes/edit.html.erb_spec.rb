...
describe "coin_attributes/edit" do
  ...
  it "renders the edit coin_attribute form" do
    ...
    assert_select "form", :action => coin_attributes_path(@coin_attribute), :method => "post" do
      ...
      assert_select "input#coin_attribute_coin_attribute_type", :name => "coin_attribute[coin_attribute_type]"
      assert_select "textarea#coin_attribute_coin_attribute_value", :name => "coin_attribute[coin_attribute_value]"
    end
  end
end
